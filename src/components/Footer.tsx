...
export const Footer = () => {
    return (
        <footer className={'bg-black w-full h-max text-white'}>
            <section>
                <div className={'flex justify-between pb-10 text-main_color'}>
                    <a href="">solakabuta@gmail.com</a>
                    <div>
                    <ul className={''}>
                ...
                <h5 className={'flex justify-between font-black max-md:text-4xl text-12xl hover:text-orange-600 duration-700 transition ease-in-out hover:rotate-3'}>
