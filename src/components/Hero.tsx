            ...
            <div className={'max-lg:grid  justify-between items-start pt-20 py-5 align-text-bottom'}>
                <div>
                    <h1 data-aos="fade-zoom-in"
                        ...
                        {/*TEST CVA*/}
                        <WordRotate className="text-4xl max-md:text-2xl font-bold text-black max-md:hidden" words={[`Hello, I am Sola`, `but my friends call me "Kam"`]}/>
                        {/* MOBILE WordRotate */}
                        <WordRotate className="text-4xl max-md:text-2xl font-bold text-black md:hidden" words={[`Hello, I am Sola`, `I am a`]}/>
                ...
                <p data-aos="fade-zoom-in"
                   data-aos-easing="ease-in-sine"
                   data-aos-duration="1200"
                   className={'text-right text-xl transition hover:-translate-x-6 ease-in-out duration-700 max-md:text-sm max-lg:text-start max-lg:pt-10 text-balance'}>
                ...
                <div data-aos="fade-zoom-in"
                    ...
                    <a href="https://www.linkedin.com/in/sola-kabuta/"
                       target={'_blank'}
                       aria-label="Read more about me on my Linkedin profile">
                        <LinkedInLogoIcon className={style.socials}/>
                    </a>
                    <a href="https://github.com/SolaKabuta"
                       target={'_blank'}
                       aria-label="See more projects on my Github profile">
