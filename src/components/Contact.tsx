...
export const Contact = () => {
    return (
        <section className={'relative'}>
            ...
            <a
                className={'font-black max-md:text-4xl text-6xl max-md:my-10 my-44 grid place-items-center text_anim transition hover:-translate-x-3 ease-in-out duration-700'}
