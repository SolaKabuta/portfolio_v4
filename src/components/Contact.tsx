        ...
        <section id={'contact'} className={'relative z-30'}>
            <div className={`py-20 relative`}>
                <VelocityScroll
                    ...
                    default_velocity={5}
                    className="font-display relative text-center max-md:text-4xl text-7xl font-black tracking-[-0.02em] text-main drop-shadow-sm dark:text-white md:text-7xl md:leading-[5rem]"
                />
                <div
